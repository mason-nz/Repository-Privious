<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Entrance_TestForBatch.aspx.cs"
    Inherits="BitAuto.DSC.IM_DMS2014.EPLogin.Test.Entrance_TestForBatch" %>
...
<body>
    ...
    <form id="form2" action="http://imtc.sys1.bitauto.com/onlineservice.aspx" method="post"
    target="_blank">
    ...
    <form id="form3" action="http://imtc.sys1.bitauto.com/onlineservice.aspx" method="post"
    target="_blank">
    ...
    <form id="form4" action="http://imtc.sys1.bitauto.com/onlineservice.aspx" method="post"
    target="_blank">
    ...
    <form id="form5" action="http://imtc.sys1.bitauto.com/onlineservice.aspx" method="post"
    target="_blank">
    ...
    <form id="form6" action="http://imtc.sys1.bitauto.com/onlineservice.aspx" method="post"
    target="_blank">
    ...
    <form id="form7" action="http://imtc.sys1.bitauto.com/onlineservice.aspx" method="post"
    target="_blank">
    ...
    <form id="form8" action="http://imtc.sys1.bitauto.com/onlineservice.aspx" method="post"
    target="_blank">
    ...
    <form id="form9" action="http://imtc.sys1.bitauto.com/onlineservice.aspx" method="post"
    target="_blank">
    ...
    <form id="form10" action="http://imtc.sys1.bitauto.com/onlineservice.aspx" method="post"
    target="_blank">
    ...
    <form id="form11" action="http://imtc.sys1.bitauto.com/onlineservice.aspx" method="post"
    target="_blank">

...
namespace BitAuto.DSC.IM_DMS2014.WebService.CC
{
    public class CCWebServiceHepler
    {
        ...
        /// <param name="imBussinessType">1.对话，2留言</param>
        /// <returns></returns>
        public string CCDataInterface_GetAddWOrderComeIn_IMJXS_SC_URL(string phone, string csID, string cbName, int cbSex, int provinceID, int cityID, int county, string memberCode, int imBussinessType)
        {
            ...
            msg = c.GetAddWOrderComeIn_IMJXS_SC_URL(authorize, callSource, phone, csid, cbName, cbSex, provinceID, cityID, county, memberCode);
            return msg;
        }
    }
}

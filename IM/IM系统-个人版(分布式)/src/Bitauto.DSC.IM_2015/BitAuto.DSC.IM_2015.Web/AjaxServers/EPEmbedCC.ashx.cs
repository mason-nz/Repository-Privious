...
namespace BitAuto.DSC.IM_2015.Web.AjaxServers
{
    ...
    {
        protected static string sysID = ConfigurationUtil.GetAppSettingValue("CCSysID");
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            try
            {
                //ret = FanXianHelper.Instance.EPEmbedCC_AuthService(userid, RoleID, RequestGoToEPURL, out msg, EPEmbedCC_APPID);
            }
            catch (Exception ex)
            {
                msg  = ex.Message;

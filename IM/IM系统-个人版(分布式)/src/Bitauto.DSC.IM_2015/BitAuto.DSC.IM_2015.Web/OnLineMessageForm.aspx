...
<div class="online_kf online_kf2" style="background-color: #fff;width:545px; margin:0; padding-bottom:0px;">
    <div class="title_kf">
    ...
    <div class="content_kf content_kf_ms">
        <!--左开始-->
        <div class="left_c">
            <div class="answer answer2" style="padding-left:15px; font-weight:bold;margin-top:10px; border:0px; padding:0px; padding-left:30px;">
                <p class="hs" style=" color:#666">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="msg_lv" width="100%">
                    <tr>
                        ...
                        <td width="90%" style=" font-size:12px; font-weight:normal;">
                            <label>
                    ...
                    <tr>
                        ...
                        <td style=" font-size:12px; font-weight:normal;">
                            <textarea name="" id="tamessagecontents" cols="" rows="" style="height: 80px; width:90%;"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>

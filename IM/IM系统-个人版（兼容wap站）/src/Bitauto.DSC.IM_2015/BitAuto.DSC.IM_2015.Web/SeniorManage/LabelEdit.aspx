<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LabelEdit.aspx.cs" Inherits="BitAuto.DSC.IM_2015.Web.SeniorManage.LabelEdit" %>
...
<script type="text/javascript">
    ...
    function addNewRow() {
        var appendStr = "<tr>"
        appendStr += "<td class='cName'><em></em><input type='text'style='width:80%;'  class='w120' autocomplete='off'><input type='hidden'  /></td>";
    ...
    function LabelSave(obj) {
        ...
        else if (labelName.length > 10) {
            $.jAlert("标签名称不能超过10个字符！");
            return false;
        }
            ...
            <asp:repeater id="rptLabel" runat="server">
                        <ItemTemplate>
                            <tr class="back" onmouseover="this.className='hover'" onmouseout="this.className='back'">
                                ...
                                <td>
                                      <em>  <%#Eval("Status").ToString()=="0"?"在用":"停用"%></em>
                                </td>                                
                                <td>

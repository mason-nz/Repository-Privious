...
AspNetComet.prototype.CheckCallBack = function (timeout) {
    timeout = timeout || (10 * 1000);
    var th = this;
    clearTimeout(th.delayTimer);
    th.delayTimer = setTimeout(function () {
        th.subscribe();
    }, timeout);
};
//
...
AspNetComet.prototype.subscribe =
    function AspNetComet_subscribe() {
                ...
                if (waitRequest.readyState == "4") {
                    ...
                    if (waitRequest.status == "200") {
                        ...
                        if (result == null || result.length == 0) {
                            ...
                            clearTimeout(aspNetComet.delayTimer);  //错误时清除计时器
                            //  failure
                            ...
                            switch (message.n) {
                                ...
                                case "aspNetComet.timeout":
                                    ...
                                    aspNetComet.iIsIp = message.serviceip;
                                ...
                                default:
                                    ...
                                    for (var i = 0; i < result.length; i++) {
                                        ...
                                        aspNetComet.iIsIp = message.serviceip;
                                        //}
                                        if (message.c && message.c.length > 1) {
                                            message.c = $.parseJSON(message.c);
                                        }
        ...
        waitRequest.send("privateToken=" + this.privateToken + "&lastMessageId=" + this.lastMessageId + "&lServiceIp=" + this.iIsIp);
        aspNetComet.CheckCallBack();
    };
...
function SetBeforeunload(flag, closeFN) {
    ...
    window.onunload = (flag != null && flag) ? function () {

...
var jsHash = {
    common: [{ src: "/Scripts/common.js", version: "1.4.9.12533"}],
    OnlineService: [{ src: "OnlineService.js", version: "1.8.729223323.1"}],
    OnlineServiceCom: [{ src: "OnlineServiceCom.js", version: "1.4.23"}],
    AgentChat: [{ src: "AgentChat.js", version: "1.1.11233332.9"}],
    AspNetComet: [{ src: "/Scripts/AspNetComet.js", version: "1.3.1254.363"}],
    MOnlineService: [{ src: "MOnlineService.js", version: "1.1.11.1" }],
    MAspNetComet: [{ src: "MAspNetComet.js", version: "1.1.11.1"}]
};

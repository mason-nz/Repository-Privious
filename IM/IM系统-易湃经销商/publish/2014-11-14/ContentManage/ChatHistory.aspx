...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            BindSelDistrictData();
            $('#txtStartTime').bind('click focus', function () { WdatePicker({ maxDate: '#F{$dp.$D(\'txtEndTime\')}', onpicked: function () { $("#txtEndTime").focus(); } }); });
                    ...
                    if (data != "") {
                        ...
                        if (jsonData != "") {
                            $.each(jsonData.root, function (idx, item) {
                                ...
                                $loginid.attr("href", "http://ncc.sys.bitauto.com/CustCheck/CrmCustSearch/MemberDetail.aspx?i=0&MemberCode=" + item.MemberCode);
    ...
    <div class="content content2">
        ...
        <div class="searchTj">
            <ul>
                ...
                <li>
                    <label>
                        最后对话时间：</label><input name="" id="txtStartTime" type="text" class="w240" style="width: 108px;" />
                    -
        ...
        <div class="kh_info">
            <div id="Tab1">
                ...
                <div class="Contentbox" style="height:364px;">
                    <!--客户信息-->

...
namespace BitAuto.DSC.IM_DMS2014.Dal
{
    public class CommonDal : DataBase
    {
        ...
        {
            return InsertComAdoInfo(info, IM_conn);
        }
        /// 修改 (自动生成)
        /// <summary>
        /// 修改 (自动生成)
        ...
        {
            return UpdateComAdoInfo(info, IM_conn);
        }
        /// 删除 (自动生成)
        /// <summary>
        /// 删除 (自动生成)
        ...
        {
            return DeleteComAdoInfo(info, IM_conn);
        }
        ...
        public bool InsertComAdoInfo<T>(T info, SqlTransaction sqltran)
        {
            ...
            {
                AttributeHelper.SetIDENTITY(info, id);
            }
            return num == 1;
        }
        /// 修改 (自动生成)

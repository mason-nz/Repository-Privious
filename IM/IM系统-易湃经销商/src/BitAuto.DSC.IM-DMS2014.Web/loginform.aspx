<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="loginform.aspx.cs" Inherits="BitAuto.DSC.IM2014.Server.Web.loginform" %>
...
<head id="Head1" runat="server">
    ...
    <link href="IMCss/login.css" rel="stylesheet" type="text/css" />
...
<body>
    <div class="page950">
        ...
        <div class="footer">
            <p>
                数据系统研发中心 任何建议和意见，请发邮件至：<a href="ISDC@bitauto.com">ISDC@bitauto.com</a></p>
            <p>
                CopyRight © Bitauto,All Rights Reserved 版权所有 北京易车互联信息技术有限公司</p>
        </div>
    </div>
</body>
...
<script type="text/javascript" language="JavaScript">
    ...
    function checkloginShowDiv() {
        ...
        var url = "AjaxServers/LoginForNoPwd.ashx";

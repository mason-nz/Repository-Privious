...
namespace BitAuto.DSC.IM_2015.Dal
{
    ...
    public class Conversations : DataBase
    {
        ...
        {
            //string strSql = string.Format("UPDATE dbo.Conversations SET TagID={0},TagName='{1}' WHERE CSID={2}",
        ...
        {
            //string sqlStr = "SELECT * FROM CC2012.dbo.WorkOrderTag WHERE 1=1  AND BGID='" + BGID + "'";

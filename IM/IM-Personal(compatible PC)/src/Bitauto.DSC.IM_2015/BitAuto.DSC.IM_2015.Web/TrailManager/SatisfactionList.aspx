<%@ Page Language="C#" Title="满意度统计" MasterPageFile="~/Controls/Top.Master" AutoEventWireup="true"
    CodeBehind="SatisfactionList.aspx.cs" Inherits="BitAuto.DSC.IM_2015.Web.TrailManager.SatisfactionList" %>
    ...
    <script type="text/javascript">
        ...
        function search(selectType) {
            ...
            if (msg != "") {
                ...
                $('#ajaxMessageInfo').load("/AjaxServers/TrailManager/SatisfactionList.aspx", podyStr);
            }
        }
        //验证数据格式
        ...
        function ShowDataByPost1(podyStr) {
            LoadingAnimation("ajaxMessageInfo");
            $('#ajaxMessageInfo').load("/AjaxServers/TrailManager/SatisfactionList.aspx", podyStr, function () { });
        }

        //导出
        function ExportData() {
            var podyStr = JsonObjToParStr(_params());
            window.location = "/AjaxServers/TrailManager/SatisfactionList.aspx?export=1&" + podyStr;
        }
    </script>
    <!--内容开始-->
    <div class="content">

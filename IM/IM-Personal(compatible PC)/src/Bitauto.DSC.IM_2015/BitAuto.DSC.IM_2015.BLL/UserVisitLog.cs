...
namespace BitAuto.DSC.IM_2015.BLL
{
    ...
    public class UserVisitLog
    {
        ...
        /// <returns></returns>
        public Entities.UserVisitLog GetUserInfo(string title, string posturl, string sourcetype, string loginid, string cityidstr, string provinceidstr, bool isWap)
        {

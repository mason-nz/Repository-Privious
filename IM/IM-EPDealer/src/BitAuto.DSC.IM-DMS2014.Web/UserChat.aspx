<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserChat.aspx.cs" Inherits="BitAuto.DSC.IM2014.Server.Web.UserChat" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function AllocAgentForUserHandler(privateToken, alias, message) {
            ...
            document.getElementById("Rmessages").innerHTML += "<p class='hs'>您好，感谢您的咨询，请问有什么可以帮您？</p>";            //让信息框和发送信息按钮可用
            //让信息框和发送信息按钮可用
        ...
        function SendMessage() {
            ...
            if (sendto == "") {
                ...
                else if ($.trim(messagetxt) == "请用一句话简要、准确地描述您的问题，如：宝马X1怎么样、易车商城下单问题") {
                    $.jAlert("消息不能为空！");
                }
        ...
        //文本框提示语
        function ClearTitle() {
            if ($("#Smessage").html() == "请用一句话简要、准确地描述您的问题，如：宝马X1怎么样、易车商城下单问题") {
                $("#Smessage").html("");
            }
        }
        //窗口关闭按钮事件
                ...
                <div class="ask">
                    ...
                    <div class="ask_c" style="height: 80%">
                        <textarea id="Smessage" style="height: 80%; overflow-y: auto;" disabled="disabled"
                            onclick="ClearTitle()" onkeypress="return onKeyPress(event)">请用一句话简要、准确地描述您的问题，如：宝马X1怎么样、易车商城下单问题</textarea></div>
                </div>

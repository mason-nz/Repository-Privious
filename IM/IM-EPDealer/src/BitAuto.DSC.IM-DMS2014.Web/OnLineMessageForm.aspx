<%@ Page Title="客户留言" Language="C#" AutoEventWireup="true" CodeBehind="OnLineMessageForm.aspx.cs"
    Inherits="BitAuto.DSC.IM_DMS2014.Web.OnLineMessageForm" %>
            ...
            <div class="answer answer2">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="msg_lv" width="100%">
                    <tr>
                        ...
                        <td width="80%">
                            <label>
                                <input name="rdmessageType" type="radio" value="1" /><span>产品咨询</span></label>
                            <label>
                                <input name="rdmessageType" type="radio" value="2" /><span>投诉及建议</span></label>
                            <label>
                                <input name="rdmessageType" type="radio" value="3" /><span>合作咨询</span></label>
                            <label>
                                <input name="rdmessageType" type="radio" value="4" /><span>其它</span></label>
                        </td>
                    </tr>
                    <tr>

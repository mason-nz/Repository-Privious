...
namespace BitAuto.DSC.IM_DMS2014.Web.AjaxServers.SeniorManage
{
    public partial class ComSenManageList : System.Web.UI.Page
    {
        ...
        private void BindData()
        {
            ...
            DataTable dt = BLL.ComSentence.Instance.GetComSentenceList(query, "cs.SortNum", BLL.PageCommon.Instance.PageIndex, PageSize, out RecordCount);//BLL.OtherTaskInfo.Instance.GetOtherTaskInfoByList(query, "OtherTaskInfo.LastOptTime Desc", BLL.PageCommon.Instance.PageIndex, PageSize, out RecordCount);

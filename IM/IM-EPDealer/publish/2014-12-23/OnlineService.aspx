             ...
             function (msg) {
                 if (msg != "") {
                     ...
                     if (r != null && r.result == 'loginok') {
                         ...
                         $("#agentAllocat").html("欢迎使用易车运营服务中心在线服务，我们的服务时间为周一至周五早<%=ST.ToString()%>至晚<%=ET.ToString()%><br/>如果您有问题需要咨询，请<a style='cursor:pointer'  onclick='SetBeforeunload(false, onbeforeunload_handler);addMessage()'>点击留言</a>，我们会在收到消息的第一时间为您处理，给您带来的不便之处敬请谅解！");
                         //网友访问id
                         visitid = r.visitid;

<%@ Page Title="历史记录" Language="C#" AutoEventWireup="true" CodeBehind="ConversationHistory.aspx.cs"
    Inherits="BitAuto.DSC.IM_DMS2014.Web.ConversationHistory" %>
    ...
    <script type="text/javascript">
        ...
        function search() {
          ...
          //  LoadingAnimation("dialogue");
            $('#dialogue').load("/ConversationHistory.aspx #dialogue > *", pody);
        }
        function ShowDataByPost1(podyStr) {
           // LoadingAnimation("dialogue");
            $('#dialogue').load("/ConversationHistory.aspx #dialogue > *", podyStr, function () { highlight(); });
        }
        function highlight() {

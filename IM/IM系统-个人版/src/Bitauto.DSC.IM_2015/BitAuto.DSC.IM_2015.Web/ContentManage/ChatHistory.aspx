...
//            $('#txtEndTime').bind('click focus', function () { WdatePicker({ minDate: '#F{$dp.$D(\'txtStartTime\')}', dateFmt: 'yyyy-MM-dd HH:mm:ss' }); });
            ...
            $('#txtStartTime').bind('click focus', function () { WdatePicker({ isShowClear: true, readOnly: true, startDate: '%y-%M-%d 00:00:00', dateFmt: 'yyyy-MM-dd HH:mm:ss', maxDate: '#F{$dp.$D(\'txtEndTime\')}', onpicked: function () { document.getElementById("txtEndTime").focus(); } }); });
            $('#txtEndTime').bind('click focus', function () { WdatePicker({isShowClear: true, readOnly: true, startDate: '%y-%M-%d 23:59:59', dateFmt: 'yyyy-MM-dd HH:mm:ss', minDate: '#F{$dp.$D(\'txtStartTime\')}' }); });
        ...
        function exportdata() {
            ...
            $("#formExport [name='ep_ProvinceID']").val(pody.ProvinceID);
            $("#formExport [name='ep_CityID']").val(pody.CityID);
    ...
    <div class="content ">
        ...
        <div class="searchTj">
            <ul>
                ...
                <li>
                    <label>
                        电话：</label>
                    <input name="" id="txtPhone" type="text" class="w240" /></li>
                <li>
                    <label>
                        地区：</label>
                    <select id="ddlSearchVisitorProvince" class="w240" style="width: 117px" name="ddlSearchVisitorProvince"
                        class="kProvince">
                    </select>
                    <select id="ddlSearchVisitorCity" class="w240" style="width: 117px" name="ddlSearchVisitorCity">
                        <option>城市</option>
                    </select>
                </li>
                <li style="width: 80px;">
            ...
            <ul style=" clear:both;">
                <li>
                    <label>
                        所属客服：</label>
                    <input name="" id="txtAgentName" type="text" class="w240" />
                </li>
                <li>
                    <label>
                ...
                <li>
                    <label>
                        最后对话时间：</label>
                    <input name="txtStartTime" id="txtStartTime" type="text" class="w240" style="width: 105px;" />
                    -
                    <input name="txtEndTime" id="txtEndTime" type="text" class="w240" style="width: 105px;" />
                </li>
                <li style="width: 80px;">
                    <div class="tjBtn">
        ...
        <!--查询结束-->
        <!--列表开始-->
        <div class="cxList2 online_dh" id="ajaxTable" style=" margin-left:1px; margin-top: 8px; width:695px; height:421px;border-left: 2px solid #E6E6E6; border-bottom: 1px solid #E6E6E6; border-top: 1px solid #E6E6E6">
        </div>
        <!--列表结束-->
        <!--信息展示-->
                ...
                <div class="Contentbox" style="height: 365px;">
                    ...
                    <div id="con_one_1" style="display: none">
                        <div class="dialogue">
                            ...
                            <div class="" id="ajaxHistoryList" style="height: 305px;overflow-y: scroll; -ms-overflow-y: scroll; overflow-x: hidden;">
                            </div>
                        </div>
                    </div>
                    <!--对话记录-->
                    <!--访客信息-->
                    <div id="con_one_2" class="hover" style="height: 365px;overflow-y: scroll; -ms-overflow-y: scroll; overflow-x: hidden;">
                    ...
                    <div id="con_one_3">
                        <div class="dialogue">
                            <div class="" id="ajaxServiceInfo" style="height: 365px;overflow-y: scroll; -ms-overflow-y: scroll; overflow-x: hidden;">
                            </div>
                        </div>
                    </div>
                    <!--服务信息-->
    ...
    <input type="hidden" name="ep_ProvinceID" value="" />
    <input type="hidden" name="ep_CityID" value="" />

    ...
    <script type="text/javascript">
        ...
        function StartChat() {
            ...
            if (SourceType == "") {
                ...
                var pody = { action: 'init', EPTitle: EPTitle, FromPrivateToken: escape(privatetaken), UserReferURL: UserReferURL, LoginID: escape(LoginID), SourceType: SourceType, EPPostURL: EPPostURL, usertype: escape(usertype), CityID: escape(bit_locationInfo.cityId), ProvinceID: escape(ProvinceID) };
                                ...
                                <div class="answer" id="divAnswer" style="position: relative; overflow: auto; *overflow-x: hidden">
                                    <div id="divagentAllocat" style="">
                                        <div class='an_tip' style='margin-bottom: 10px;'>
                                            <div class="an_info">
                                                <img width='16' height='16' src='images/an_dd.png'>您好，欢迎使用易车在线客服。稍候会有客服为您服务...
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="ask">
                                    <div class="style_1">
                                        <span class="kind_detail"><a href="#" id="bq_listSH" title="表情" class="fw_bq" style="display: none">
                                            ...
                                            class="fw_jl"></a><a href="#" id="fileUpload" title="上传文件" style="display: none"
                                                class="fw_sc">
                                                <input type="file" id="uploadify" name="uploadify" /></a><a href="#" id="btnCapture"
                                                    title="截屏" class="fw_jp" onclick="jieping()" style="display: none"></a><a href="#"
                                                        id="EMYiChe" onclick="addSatisfaction()" title="满意度" class="fw_my" style="display: none"></a><a

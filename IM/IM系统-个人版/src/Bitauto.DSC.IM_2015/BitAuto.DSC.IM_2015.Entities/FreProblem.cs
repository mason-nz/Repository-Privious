...
namespace BitAuto.DSC.IM_2015.Entities
{
    ...
    public class FreProblem
    {
            ...
            : this()
        {
            ...
            _sourcetype = (!dr.Table.Columns.Contains("SourceType") || dr["SourceType"] == null || dr["SourceType"] == DBNull.Value) ? null : (string)Convert.ToString(dr["SourceType"]);
        ...
        [DBFieldAttribute("SourceType", SqlDbType.VarChar, 20)]
        public string SourceType { get { return _sourcetype; } set { if (_sourcetype != value) { _sourcetype = value; isModify_SourceType = true; } } }
        public string ValueOrDefault_SourceType { get { return _sourcetype != null ? _sourcetype : ""; } }

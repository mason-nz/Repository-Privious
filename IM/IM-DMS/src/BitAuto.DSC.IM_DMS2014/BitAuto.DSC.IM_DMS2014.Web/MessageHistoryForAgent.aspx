<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MessageHistoryForAgent.aspx.cs" Inherits="BitAuto.DSC.IM_DMS2014.Web.MessageHistoryForAgent" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function search() {
            ...
            $('#dialogue').load("/MessageHistoryForAgent.aspx #dialogue > *", pody);
        }
        function ShowDataByPost1(podyStr) {
            // LoadingAnimation("dialogue");
            $('#dialogue').load("/MessageHistoryForAgent.aspx #dialogue > *", podyStr, function () { highlight(); });
        }
        function highlight() {
...
<body>
    ...
    <div class="online_kf">
        <div class="title_kf">
            历史记录<span><a href="#"><img src="images/c_btn.png" border="0" alt="关闭" /></a></span></div>
        <div class="content_kf" style=" overflow:scroll; overflow-x:hidden; background-color:White; margin:10px;">
            <div class="his_jl">
                <!--查询开始-->
                <div class="searchTj">
                    <ul>

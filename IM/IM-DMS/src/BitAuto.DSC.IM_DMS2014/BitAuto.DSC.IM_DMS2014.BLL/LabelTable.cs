...
namespace BitAuto.DSC.IM_DMS2014.BLL
{
	...
	public class LabelTable
	{
		...
		{
			int totalCount=0;
			return Dal.LabelTable.Instance.GetLabelTable(new QueryLabelTable(),string.Empty,1,1000000,out totalCount);
		}
        /// <summary>
        /// 获取全部标签 及 标识是否所属当前组
        /// </summary>
        ...
        /// <returns></returns>
        public DataTable GetLabelTableByBGID(int bgid)
        {
            return Dal.LabelTable.Instance.GetLabelTableByBGID(bgid);
        }
		#endregion

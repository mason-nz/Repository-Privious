    ...
    public partial class ConversationHistoryForCC : System.Web.UI.Page
    {
        ...
        public bool CheckUser()
        {
            try
            {
                ...
                //if (int.TryParse(jsondata.CSID, out csid))
                //{
                //    Entities.Conversations modelConversation = BLL.Conversations.Instance.GetConversations(csid);
                //    if (modelConversation != null)
                //    {
                //        int conversationCreateUserId = 0;
                //        if (modelConversation.UserID.HasValue)
                //        {
                //            conversationCreateUserId = modelConversation.UserID.Value;
                //        }
                //        if (currentuserid == conversationCreateUserId)
                //        {
                //            return true;
                //        }
                //    }

...
namespace BitAuto.DSC.IM_2015.Web
{
    public partial class AgentChat : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (DefaultChannelHandler.StateManager.GetCometClient(AgentId) != null)
            {
                IsDuplicateLogin = "1";
                return;
            }
        ...
        private void GetAllLableWithCM()
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                if (!dtLabel.ContainsKey(Convert.ToInt32(dr[0])))
                {
                    ...
                    sbReuslt.Append(
                        "<ul name='ulLiItem' style='position: absolute; z-index: 999; left: 65px; top: -10px; border: #e0e0e0 1px solid; width: 200px; background: #FFF; border-radius: 10px; height:432px;overflow-y:auto;'>");

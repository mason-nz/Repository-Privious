...
namespace BitAuto.DSC.IM_2015.Web.AjaxServers
{
    ...
    public class LayerDataHandler : IHttpHandler, IRequiresSessionState
    {
        ...
        private void GetEmotionInfoByECategory(out string msg)
        {
            ...
            DataTable dt = BLL.Emotions.Instance.GetEmotionInfoByECategory(" and ECategory='" + ECategory + "'");
            if (dt.Rows.Count > 0)
            {
                msg += "{root:[";
            }
        ...
        private void GetOrderInfoByOrderID(out string msg)
        {
            ...
            DataTable dt = BLL.Conversations.Instance.GetWorkOrderInfoByOrderID(" and a.OrderID='" + OrderID + "'");
            if (dt.Rows.Count > 0)
            {
                msg += "{root:[";
            }
        ...
        private void GetCSRelateInfoByCSID(out string msg)
        {
            ...
            DataTable dt = BLL.Conversations.Instance.GetCSRelateInfoByCSID(" and a.CSID='" + CSID + "'");
            if (dt.Rows.Count > 0)
            {
                msg += "{root:[";
            }
        ...
        private void GetMemberInfoByVisitID(out string msg)
        {
            ...
            DataTable dt = BLL.Conversations.Instance.GetMemberInfoByVisitID(" and a.VisitID='" + VisitID + "'  AND b.CSID='" + CSID + "'");
            if (dt.Rows.Count > 0)
            {
                msg += "{root:[";
            }

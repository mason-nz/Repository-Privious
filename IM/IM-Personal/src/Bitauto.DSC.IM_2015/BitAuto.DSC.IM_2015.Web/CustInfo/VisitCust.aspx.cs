        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                if (!string.IsNullOrEmpty(loginid))
                {
                    ...
                    #region 加载访客信息
                    Core.CometClient modelclient = null;
                    Entities.UserVisitLog model = null;
                    //modelclient = DefaultChannelHandler.StateManager.GetCometClient(loginid);
                    if (modelclient == null)
                    {
                    ...
                    {
                        //内存加载
                        //AgentSTime = modelclient.AgentSTime.ToString();
                        //ConvertsTime = modelclient.ConverSTime.ToString();
                        //model = modelclient.Userloginfo;
                    }
                    ...
                    if (!string.IsNullOrEmpty(model.UserName.Trim()) && !string.IsNullOrEmpty(model.Phone.Trim()))
                    {
                        ...
                        if (CEntityModel != null)
                        {
                            ...
                            if (modelclient != null)
                            {
                                modelclient.Userloginfo.CustID = CEntityModel.CustID;
                            }

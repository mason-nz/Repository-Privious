...
(function($) {
    ...
    $.closePopupLayer = function(name, effectiveAction) {
        var ea = false;
    ...
    function setScreenLockerSize() {
        if (popupLayerScreenLocker) {
            $('#popupLayerScreenLocker').height($(document).height() * 1.04 + "px"); //修改遮盖层高度，1.04倍，Modify=Masj，Date=2009-12-24
    ...
    function hideScreenLocker(popupName) {
        if (openedPopups.length == 0) {
            ...
            var z = parseInt($("#popupLayer_" + openedPopups[openedPopups.length - 1].name).css("z-index"));
            if (isNaN(z)) { z = 7000; }
            $('#popupLayerScreenLocker').css("z-index", z - 1);
        }
    ...
    */
    $.jAlert = function(message, afterCloseCallBack) {
        ...
        var btnPopup_ok = '<input type="button" value=" OK " onclick="javascript:$.closePopupLayer(\'' + alertName + '\');" style="width: 50px; height: 22px;"/>';
    ...
    */
    $.jConfirm = function(message, jConfirmAfterClose) {
        ...
        var btnPopup_ok = '<input type="button" value=" OK " onclick="javascript:$.closePopupLayer(\'' + alertName + '\',true);" style="width: 50px; height: 22px;"/>';
        var btnPopup_cancel = '<input type="button" value=" Cancel " onclick="javascript:$.closePopupLayer(\'' + alertName + '\',false);" style="width: 50px; height: 22px;"/>';
    ...
    */
    $.jPopMsgLayer = function(msg, second, afterCloseCallBack) {
        $('#divPopMsg').remove();
        var objDiv = $('<div/>');

...
namespace XYAuto.ChiTu2018.Service.LuckDrawActivity
{
    /// <summary>
    /// 注释：LuckDrawService
    /// 作者：lix
    ...
    public class LuckDrawService
    {
        ...
        private static readonly Lazy<LuckDrawService> Linstance = new Lazy<LuckDrawService>(() => new LuckDrawService());
        public static LuckDrawService Instance => Linstance.Value;
        #endregion

...
using XYAuto.ChiTu2018.WeChat.CommonService.CustomMessageHandler;
...
namespace XYAuto.ChiTu2018.API.Controllers
{
    public class WeChatController : Controller
    {
        ...
        [System.Web.Http.ActionName("SayHello")]
        ...
        {
            Log4NetHelper.Default().Info($"[WeChatController]Get {JsonConvert.SerializeObject(postModel)}");
        ...
        {
            Log4NetHelper.Default().Info($"[WeChatController]Post {JsonConvert.SerializeObject(postModel)}");
            if (!CheckSignature.Check(postModel.Signature, postModel.Timestamp, postModel.Nonce, Token))
            {
                return Content("参数错误！");
            }
            ...
            catch (Exception ex)
            {
                ...
                Log4NetHelper.Default().Info("WeChatController>Post Error:" + ex.Message);

...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        // 服务器统一请求接口路径
        , serverUrl: "/js/ueditor-master/ueditor/net/controller.ashx"
        , configUrl: "/js/135editor/plugin_v1.1/config.js"
        //, configUrl: "/js/ueditor-master/ueditor/net/config.json"
        ...
        ['cleardoc',"paragraph","fontfamily","fontsize","inserttable",'background',"horizontal","|","undo","redo","|","more"],
        ["source", 'remotecontent', 'spechars', 'emotion', 'link', 'superscript', 'subscript', 'insertorderedlist', 'insertunorderedlist', 'directionalityltr', 'directionalityrtl', 'searchreplace', 'help', 'message', 'preview']
        ]
        // 'simpleupload','music','pagebreak','touppercase', 'tolowercase', /*"uploadword",'simpleupload',"insertimage",*/

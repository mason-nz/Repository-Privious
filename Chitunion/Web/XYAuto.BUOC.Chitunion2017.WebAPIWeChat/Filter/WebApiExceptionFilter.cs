...
namespace XYAuto.BUOC.Chitunion2017.WebAPIWeChat.Filter
{
    public class WebApiExceptionFilter : ExceptionFilterAttribute
    {
        ...
        public override void OnException(HttpActionExecutedContext context)
        {
            ...
            Loger.Log4Net.Error("Chitunion_WebAPIWeChat——异常", context.Exception);
...
内部错误StackTrace：{14}",
            ...
            string subject = "Chitunion_WebAPIWeChat——报错通知";
            ...
            if (userEmail != null && userEmail.Length > 0)
            {
                ...
                ITSC.Chitunion2017.BLL.EmailHelper.Instance.SendErrorMail(mailBody, subject, userEmail);
            }

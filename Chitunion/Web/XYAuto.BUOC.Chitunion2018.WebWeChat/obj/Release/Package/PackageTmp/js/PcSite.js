$(function () {
    var chituDomainName='http://www1.chitunion.com'
    ...
    $('.pc_inquiry button').on('click',function () {
        if($('.Models option:selected').attr('CarSerialId')!=-2){
            window.location='http://h5.qichedaquan.com/carserial/?serialId='+$('.Models option:selected').attr('CarSerialId')
        }else {
            window.location='http://h5.qichedaquan.com/jike/'
        }
    })

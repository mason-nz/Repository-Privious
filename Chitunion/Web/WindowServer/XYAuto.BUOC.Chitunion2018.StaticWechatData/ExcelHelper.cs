...
namespace XYAuto.BUOC.Chitunion2018.StaticWechatData
{
    ...
    public class ExcelHelper
    {
        ...
        /// 将数据导出至Excel文件  
        /// </summary>  
        /// <param name="DicDt">DataTable字段对象</param>  
        /// <param name="ExcelFilePath">Excel文件路径</param>  
        public static bool OutputToExcel(Dictionary<string, DataTable> DicDt, string ExcelFilePath)
        {
            if (File.Exists(ExcelFilePath))
            {
                File.Decrypt(ExcelFilePath);
            }
            string connString = "Provider=Microsoft.Ace.OleDb.12.0;" + "data source=" + ExcelFilePath + ";Extended Properties='Excel 12.0;'"; //此连接可以操作.xls与.xlsx文件 (支持Excel2003 和 Excel2007 的连接字符串)                                                                                                                                                                                                                                                  //string connString = @"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + ExcelFilePath + ";Extended Properties=Excel 8.0;";
            OleDbConnection objConn = new OleDbConnection(connString);

            foreach (var item in DicDt)
            {
        ...
        public static bool OutputToExcel(DataTable Table, ArrayList Columns, string ExcelFilePath)
        {
            ...
            string connString = "Provider=Microsoft.Ace.OleDb.12.0;" + "data source=" + ExcelFilePath + ";Extended Properties='Excel 12.0;'"; //此连接可以操作.xls与.xlsx文件 (支持Excel2003 和 Excel2007 的连接字符串)  
            //连接字符串  

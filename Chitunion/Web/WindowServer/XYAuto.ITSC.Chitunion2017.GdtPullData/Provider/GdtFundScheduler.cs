...
namespace XYAuto.ITSC.Chitunion2017.GdtPullData.Provider
{
    internal class GdtFundScheduler
    {
        ...
        public class DoPullGetFundsInfo : IJob
        {
            public void Execute()
            {
                BLL.Loger.GdtLogger.Info($" GdtFundScheduler DoPullGetFundsInfo start..");
        ...
        public class DoPullGetRealtimeCost : IJob
        {
            public void Execute()
            {
                BLL.Loger.GdtLogger.Info($" GdtFundScheduler DoPullGetRealtimeCost start..");
        ...
        public class DoPullGetFundStatementsDaily : IJob
        {
            public void Execute()
            {
                BLL.Loger.GdtLogger.Info($" GdtFundScheduler DoPullGetFundStatementsDaily start..");
        ...
        public class DoPullGetFundStatementsDetailed : IJob
        {
            public void Execute()
            {
                BLL.Loger.GdtLogger.Info($" GdtFundScheduler DoPullGetFundStatementsDetailed start..");

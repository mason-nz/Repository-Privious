                ...
                switch(userInfo.Status){
                    ...
                    case 2://认证成功--验证提现账号
                        if( !userInfo.AccountName ){
                            ...
                            if( userInfo.CanWithdrawalsMoney < 100 ){
                                layer.msg('可提现金额不足100元，无法提现！',{'time':2000});
                            }else{
                ...
                success: function () {
                    ...
                    $('#cashAccount').off('blur').on('blur',function(){
                        ...
                        if( !WithdrawalsPrice ){
                            ...
                            return
                        }else if(WithdrawalsPrice < 100){
                            $('.moneyInfo').removeClass('hide').find('.red').html('提现金额不足100元，无法提现！');
                            $('.forPerson').addClass('hide');
                            return
                    ...
                    $('#sure_submmit').off('click').on('click',function(){
                        ...
                        if( !WithdrawalsPrice ){
                            ...
                            $('.tipInfo_final').html('<img src="/images/icon7.png">提现金额不足100元，无法提现').show();
                            return
                        }
                        if( !checkCode ){
                                   ...
                                   $.ajax({
                                        ...
                                        success:function(data){
                                            if(data.Status == 0){
                                                ...
                                                $('.tipInfo_final').html('提现金额不足100元，无法提现').show();
                                                $('#vertifyCode').click();
                                            }else{
                                                layer.msg('提交失败，请稍后重试',{time:2000});
                                            }

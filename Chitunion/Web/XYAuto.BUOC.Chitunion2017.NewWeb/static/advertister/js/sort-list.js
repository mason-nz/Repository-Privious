...
$(function () {
    ...
    WxList.prototype = {
        ...
        InitParams: function (idx) {//参数
            ...
            $('input[name=fan]').eq(0).on('keypress',function(evt){
                evt = evt = (evt) ? evt : ((window.event) ? window.event : "");
                if(evt.keyCode == "13") {//keyCode=13是回车键
                    $('#FanSure').click();
                }  
            })
            $('input[name=fan]').eq(1).on('keypress',function(evt){
                evt = evt = (evt) ? evt : ((window.event) ? window.event : "");
                if(evt.keyCode == "13") {//keyCode=13是回车键
                    $('#FanSure').click();
                }  
            ...
            $('input[name=price]').eq(0).on('keypress',function(evt){
                evt = evt = (evt) ? evt : ((window.event) ? window.event : "");
                if(evt.keyCode == "13") {//keyCode=13是回车键
                    $('#PriceSure').click();
                }  
            })
            $('input[name=price]').eq(1).on('keypress',function(evt){
                evt = evt = (evt) ? evt : ((window.event) ? window.event : "");
                if(evt.keyCode == "13") {//keyCode=13是回车键
                    $('#PriceSure').click();
                }  

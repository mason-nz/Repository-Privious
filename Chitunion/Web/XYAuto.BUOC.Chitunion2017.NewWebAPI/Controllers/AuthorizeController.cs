...
namespace XYAuto.BUOC.Chitunion2017.NewWebAPI.Controllers
{
    ...
    public class AuthorizeController : ApiController
    {
        ...
        public JsonResult GetMenuInfo()
        {
            ...
            DataTable dt = XYAuto.ITSC.Chitunion2017.Common.UserInfo.Instance.GetMenuModuleInfo(XYAuto.ITSC.Chitunion2017.Common.UserInfo.GetLoginUserID());
        ...
        public JsonResult GetLoginInfo()
        {
            ...
            DataTable dt = XYAuto.ITSC.Chitunion2017.Common.Dal.UserInfo.Instance.GetLoginUserInfo(userid, XYAuto.ITSC.Chitunion2017.Common.UserInfo.SYSID);//XYAuto.YanFa.OASysRightManager2011.Common.EmployeeInfo.Instance.GetEmployeeInfoByUserID(userid);
            if (dt != null && dt.Rows.Count > 0)
            {
        ...
        public JsonResult CheckRight(dynamic obj)
        {
            try
            {
                ...
                if (list != null && list.Count() > 0)
                {
                    ...
                    {
                        bool f = XYAuto.ITSC.Chitunion2017.Common.UserInfo.CheckRight(moduleID, XYAuto.ITSC.Chitunion2017.Common.UserInfo.SYSID);
                        dic.Add(moduleID, f);
                    }
                }
            ...
            {
                ITSC.Chitunion2017.BLL.Loger.Log4Net.Error("调用接口CheckRight报错", ex);
        ...
        public JsonResult SyncLoginFromOtherSys(string accessToken, int userID, string mobile)
        {
            try
            {
                if (!XYAuto.ITSC.Chitunion2017.Common.AuthorizeLogin.Instance.Verification(accessToken))
                ...
                int retval = 0;
                retval = XYAuto.ITSC.Chitunion2017.Common.AuthorizeLogin.Instance.p_UserBroker_Update(userID, mobile, out msg);
            ...
            {
                ITSC.Chitunion2017.BLL.Loger.Log4Net.Error("调用失败：" + ex.Message);
        ...
        //        XYAuto.ITSC.Chitunion2017.Common.Entities.AuthorizeLogin model = new XYAuto.ITSC.Chitunion2017.Common.Entities.AuthorizeLogin()
        //        {
        //            APPID = appid,
        //            IP = requestIP,

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HomeWeiBoList.aspx.cs" Inherits="XYAuto.ITSC.Chitunion2017.Web.RecommendManager.HomeWeiBoList" %>
...
<body>
            ...
            <div class="order_r">
                <div class="list_box">
                    ...
                    <div id="tab_list">
                        ...
                        <ul class="state">
                            <li>
                                <div class="ins_c">微博昵称：</div>
                                <input id="searchKw" type="text" placeholder="请输入微博昵称" style="width: 173px;"></li>
                            ...
                            <li class="but_query" id="sina" style="float: right;width: 70px; margin-right: 10px">预览</li>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("div").data("CategoryID", 19);
            $("div").data("MediaTypeID", 14003);
        });
    </script>
</body>
</html>
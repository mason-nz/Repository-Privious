...
namespace XYAuto.ITSC.Chitunion2017.Web.AjaxServers.WeChat
{
    ...
    public partial class CustomMessageHandler : MessageHandler<CustomMessageContext>
    {
        ...
        public CustomMessageHandler(Stream inputStream, Senparc.Weixin.MP.Entities.Request.PostModel postModel, int maxRecordCount = 0)
...
<a href=""http://sdk.weixin.senparc.com/FilterTest/Redirect"">点击这里</a>进行客户端约束测试（地址：http://sdk.weixin.senparc.com/FilterTest/Redirect），如果在微信外打开将重定向一次URL。";
            ...
            else if (requestMessage.Content == "托管" || requestMessage.Content == "代理")
            {
                ...
                var agentResponseMessage = ResponseMessageBase.CreateFromResponseXml(responseXml);
            ...
            {
                var openResponseMessage = ResponseMessageBase.CreateFromRequestMessage<ResponseMessageNews>(requestMessage);
...
测试完成后，您可以登陆公众号后台取消授权。",
            ...
            {
                var errorResponseMessage = ResponseMessageBase.CreateFromRequestMessage<ResponseMessageText>(requestMessage);
            ...
            else if (requestMessage.Content == "容错")
            {
                ...
                var faultTolerantResponseMessage = ResponseMessageBase.CreateFromRequestMessage<ResponseMessageText>(requestMessage);

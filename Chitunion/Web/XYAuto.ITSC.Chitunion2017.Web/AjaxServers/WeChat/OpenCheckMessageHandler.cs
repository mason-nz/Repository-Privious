...
namespace XYAuto.ITSC.Chitunion2017.Web.AjaxServers.WeChat
{
    ...
    public class OpenCheckMessageHandler : MessageHandler<CustomMessageContext>
    {
        ...
        public OpenCheckMessageHandler(Stream inputStream,Senparc.Weixin.MP.Entities.Request.PostModel postModel, int maxRecordCount = 0)
        ...
        public override IResponseMessageBase OnTextRequest(RequestMessageText requestMessage)
        {
            ...
            {
                var responseMessage = EntityHelper.CreateResponseMessage<ResponseMessageText>(requestMessage);

...
namespace XYAuto.ITSC.Chitunion2017.Web
{
    ...
    {
        protected static string ExitSYSAddress = ConfigurationUtil.GetAppSettingValue("ExitSYSAddress");
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                Response.Redirect(ExitSYSAddress+ "/SystemManager/ShowAllSys.aspx");
                //LoginLogic();
            }
        }

$(function () {
    ...
    Listofadvertiopera.prototype={
        ...
        Rendering:function () {
            var _this=this;
            var url='http://www.chitunion.com/api/ZhyInfo/SelectZhyOperaterList'
            ...
            $('.Associatedadvertiser').off('click').on('click',function () {
                ...
                $.openPopupLayer({
                    ...
                    success: function (data) {
                        ...
                        // 右侧
                        $.ajax({
                            url: 'http://www.chitunion.com/api/ZhyInfo/SelectOptAdvertiserList',
                            type: 'get',
                            data: {
                                OperaterId:UserId
                            },
                        ...
                        $('#submitMessage').off('click').on('click',function () {
                            // if($('#tar-city option').length==0){
                            //     layer.msg('请选择要关联的广告主');
                            //     return false;
                            // }
                            var arr=[];

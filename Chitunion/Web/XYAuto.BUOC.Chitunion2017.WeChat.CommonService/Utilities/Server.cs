...
namespace XYAuto.BUOC.Chitunion2017.WeChat.CommonService.Utilities
{
    public static class Server
    {
        ...
        public static HttpContext HttpContext
        {
            get
            {
                ...
                if (context == null)
                {
                    HttpRequest request = new HttpRequest("Default.aspx", "http://wxtest-ct.qichedaquan.com/default.aspx", null);

...
@XmlType(name = "", propOrder = { "getEmployeeChangeDataByDateByCtripResult" })
...
public class GetEmployeeChangeDataByDateByCtripResponse {
	...
	/**
	 * 获取getEmployeeChangeDataByDateByCtripResult属性的值。
	 * 
	...
	/**
	 * 设置getEmployeeChangeDataByDateByCtripResult属性的值。
	 * 
	 * @param value

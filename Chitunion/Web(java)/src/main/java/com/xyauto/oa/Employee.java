...
@XmlType(name = "Employee", propOrder = { "employeeID", "domainAccount", "password", "cnName", "enName", "nickName",
		"employeeNumber", "postTitle", "email", "telephone", "mobile", "department", "seat", "isActive", "titleRank",
		"managerNumber", "dimissionDate", "entryDate", "officePlaceID", "officePlace", "serviceLengthStartTime",
		"seriateWorkStartTime", "regularWorkDate", "lastWorkDimissionDate", "workCharacter", "birthDay", "idType",
		"idCode", "sex" })
public class Employee {
	 ...
	 * 获取officePlace属性的值。
	 * 
	 * @return possible object is {@link OfficePlace }
	 * 
	 */
	 ...
	 * 
	 * @param value
	 *            allowed object is {@link OfficePlace }
	 * 
	 */

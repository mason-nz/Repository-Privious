    ...
    public partial class Login : System.Web.UI.Page
    {
        ...
        private void LoginLogic()
        {
            ...
            try
            {
                ...
                {
                    DataTable dtParent = ITSC.Chitunion2017.Common.UserInfo.Instance.GetMenuModuleInfo(lu.UserID);//ITSC.Chitunion2017.Common.UserInfo.Instance.g(lu.UserID);
                    if (dtParent != null)
                    {
                        if (string.IsNullOrEmpty(dtParent.Rows[0]["Url"].ToString()))
                        {

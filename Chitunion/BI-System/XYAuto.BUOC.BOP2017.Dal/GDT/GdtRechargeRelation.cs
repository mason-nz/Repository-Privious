...
namespace XYAuto.BUOC.BOP2017.Dal.GDT
{
    ...
    public partial class GdtRechargeRelation : DataBase
    {
        ...
        /// 增加一条数据
        /// </summary>
        public int Insert(Entities.GDT.GdtRechargeRelation entity)
        {
        ...
        public void UpdateConfirmTime(int demandBillNo, string rechargeNumber)
        {
            var sql = @"
                        UPDATE DBO.GDT_RechargeRelation SET ConfirmTime = @ConfirmTime,RechargeStatus = 90002
                        WHERE DemandBillNo = @DemandBillNo AND RechargeNumber = @RechargeNumber
                    ";
            var parameters = new SqlParameter[]{
                        new SqlParameter("@DemandBillNo",demandBillNo),
                           new SqlParameter("@RechargeNumber",rechargeNumber),
                           new SqlParameter("@ConfirmTime",DateTime.Now)
                        };

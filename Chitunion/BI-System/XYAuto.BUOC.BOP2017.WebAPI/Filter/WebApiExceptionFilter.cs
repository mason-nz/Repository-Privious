...
namespace XYAuto.BUOC.BOP2017.WebAPI.Filter
{
    public class WebApiExceptionFilter : ExceptionFilterAttribute
    {
        ...
        private const string originHeaderdefault = "http://bop1.chitunion.com";
        ...
        public override void OnException(HttpActionExecutedContext context)
        {
            ...
            Loger.Log4Net.Error("Chitunion_BOP2017商业运营中心api——异常", context.Exception);

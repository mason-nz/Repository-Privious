...
namespace XYAuto.BUOC.BOP2017.BLL
{
    public class RoleInfoMapping
    {
        ...
        {
            var roleIds = ITSC.Chitunion2017.Common.UserInfo.GetLoginUserRoleIDs();
        ...
        {
            var dt = ITSC.Chitunion2017.Common.Dal.UserInfo.Instance.GetLoginUserInfo(userId, ITSC.Chitunion2017.Common.UserInfo.SYSID);
        ...
        {
            var isVerify = false;
            var roleIds = userId == 0 ? ITSC.Chitunion2017.Common.UserInfo.GetLoginUserRoleIDs()
        ...
        public static int GetCurrentUserId()
        {
            ...
            try
            {
                userId = ITSC.Chitunion2017.Common.UserInfo.GetLoginUserID(); //获取用户id
            }
            catch
            {

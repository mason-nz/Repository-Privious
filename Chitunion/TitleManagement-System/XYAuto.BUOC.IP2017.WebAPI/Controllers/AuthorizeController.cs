...
using XYAuto.BUOC.IP2017.WebAPI.Common;
using XYAuto.BUOC.IP2017.WebAPI.Filter;
using XYAuto.ITSC.Chitunion2017.Common;
using Util = XYAuto.BUOC.IP2017.WebAPI.Common.Util;
...
namespace XYAuto.BUOC.IP2017.WebAPI.Controllers
{
    ...
    public class AuthorizeController : ApiController
    {
        ...
        //public JsonResult CleanImgTest()
        //{
        //    string url = "http://img4.qcdqcdn.com/group4/M00/53/53/QQ0DAFmxFmyAJZTbAAAhQQ6r-aM074.jpg";
        //    string result_url = XYAuto.Common.Util.CleanImg(url);
        //    return Util.GetJsonDataByResult(result_url, "Success");
        //}
        ...
        public JsonResult GetMenuInfo()
        {
            ...
            DataTable dt = ITSC.Chitunion2017.Common.UserInfo.Instance.GetMenuModuleInfo(ITSC.Chitunion2017.Common.UserInfo.GetLoginUserID());
        ...
        public JsonResult GetLoginInfo()
        {
            ...
            DataTable dt = ITSC.Chitunion2017.Common.Dal.UserInfo.Instance.GetLoginUserInfo(userid, ITSC.Chitunion2017.Common.UserInfo.SYSID);//XYAuto.YanFa.OASysRightManager2011.Common.EmployeeInfo.Instance.GetEmployeeInfoByUserID(userid);
            if (dt != null && dt.Rows.Count > 0)
            {
        ...
        public JsonResult CheckRight(dynamic obj)
        {
            try
            {
                ...
                if (list != null && list.Count() > 0)
                {
                    ...
                    {
                        bool f = ITSC.Chitunion2017.Common.UserInfo.CheckRight(moduleID, ITSC.Chitunion2017.Common.UserInfo.SYSID);
                        dic.Add(moduleID, f);
                    }
                }
            ...
            {
                Loger.Log4Net.Error("调用接口CheckRight报错", ex);
        ...
        //    try
        //    {
        //        if (!ITSC.Chitunion2017.Common.AuthorizeLogin.Instance.Verification(accessToken))
        ...
        //        int retval = 0;
        //        retval = ITSC.Chitunion2017.Common.AuthorizeLogin.Instance.p_UserBroker_Update(userID, mobile, out msg);
        ...
        //    catch (Exception ex)
        //    {
        //        Loger.Log4Net.Error("调用失败：" + ex.Message);
        ...
        //        XYAuto.ITSC.Chitunion2017.Common.Entities.AuthorizeLogin model = new ITSC.Chitunion2017.Common.Entities.AuthorizeLogin()
        //        {
        //            APPID = appid,
        //            IP = requestIP,

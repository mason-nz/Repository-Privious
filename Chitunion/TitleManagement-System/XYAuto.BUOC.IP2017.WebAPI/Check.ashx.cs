    ...
    public class Check : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            else
            {
                ...
                {
                    context.Response.Write("document.write(\"<sc\"+\"ript>window.location='" + XYAuto.Utils.Config.ConfigurationUtil.GetAppSettingValue("ExitAddress") + "/Login.aspx?gourl=' + encodeURIComponent(window.location + '');" + "</scr\"+\"ipt>\");");
                }
            }
        }

/*
* Written by:     wangcan
* function:       媒体查看--审核人在已审列表查看媒体，显示原审
* Created Date:   2017-10-20
* Modified Date:  
*/
$(function(){
    var LabelUrl = {
        ViewAuditedMeida:labelApi.tag+'/api/ExamineLabel/QueryAuditMediaLabel'//审核人查看媒体
    }
	function GetRequest() {
    ...
    setAjax({
    	...
    	if(data.Status == 0){
            ...
            $('.changeLeft .sonip').each(function(){
                ...
                ml = l;
                $(this).css({'marginBottom':h,'marginLeft':l})
            })

/*
* Written by:     wangcan
* function:       查看文章--媒体标签录入列表--审核中、已审查看，显示原审
...
$(function(){
    ...
    setAjax({
        ...
        if(data.Status == 0){
            ...
            if(returnData.ArticleIDs == ''){
                window.location = '/TagManager/ViewMedia.html?BatchMediaID='+GetRequest().BatchMediaID
            }
            var isEqual = {
                isCategory:true,
                isMarketScene:true,
            ...
            //分类
            if(returnData.Category.Original.length){
            ...
            //场景
            if(returnData.MarketScene.Original.length){
            ...
            //分发场景
            if(returnData.DistributeScene.Original.length){

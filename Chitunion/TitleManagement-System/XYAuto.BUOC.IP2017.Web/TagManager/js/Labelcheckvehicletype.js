$(function () {
    ...
    ToExamine.prototype = {
        ...
        right: function () {
            var _this=this;
            setAjax({
                url: labelApi.tag+'/api/ExamineLabel/QueryPendingAuditBrandLabel',
                // url:'json/Labelcheckvehicletype.json',
                type: 'GET',
                data: {
                    ...
                    success: function (data){
                        if(data.Status == 0){
                            layer.msg('成功',{time:1000}, function () {
                                if(GetRequest().SelectType==1){
                                    window.location='/TagManager/LabelAuditList.html?isSearch=1'
                                }else {
                                    window.location='/TagManager/carLabelManage.html?isSearch=1'
                                }
                            })
                        }else{
                            layer.msg(data.Message);

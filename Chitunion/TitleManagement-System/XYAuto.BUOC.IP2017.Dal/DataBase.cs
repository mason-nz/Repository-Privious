...
namespace XYAuto.BUOC.IP2017.Dal
{
    ...
    {
        protected static string CONNECTIONSTRINGS = GetConnectionStrings("ConnectionStrings_IP");
        protected static string CONNECTIONSTRINGS_ITSC = GetConnectionStrings("ConnectionStrings_ITSC");
        protected static string ConnectBaseData2017 = GetConnectionStrings("ConnectionStrings_BaseData2017");

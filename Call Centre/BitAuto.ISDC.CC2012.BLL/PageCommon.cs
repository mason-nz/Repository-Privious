    ...
    public class PageCommon
    {
        ...
        private string LinkStringJs(string parameters, int groupLength, int totalcount, int pageSize, int pageIndex, int type)
        {
            ...
            else
            {
                ...
                str += "<a href='javascript:ShowDataByPost" + type + "(\"" + parameters + "page=1\");' class='down' title='首页'>首页</a>&nbsp;<a href='javascript:ShowDataByPost" + type + "(\"" + parameters + "page=" + (page - 1) + "\");' class='down' title='上一页'>上一页</a>&nbsp;";
            ...
            for (int j = 1; j <= gSum; j++)
            {
                if (page >= ((j - 1) * gNum + 1) && page <= (j * gNum))
                {
                    if (page > gNum)
                    {
                        ...
                        str += "│<a href='javascript:ShowDataByPost" + type + "(\"" + parameters + "page=" + ((j - 2) * gNum + 1) + "\");' class='down'   title='前" + gNum.ToString() + "页'>...</a>";
                    ...
                    for (int p = (j - 1) * gNum + 1; p <= (j * gNum); p++)
                    {
                        ...
                        else
                        {
                            if (p <= (j * gNum) && p <= pSum)
                            {
                                ...
                                str += "│<a href='javascript:ShowDataByPost" + type + "(\"" + parameters + "page=" + p + "\");' class='down'  title='第" + p.ToString() + "页'>" + p.ToString() + "</a>";
                    ...
                    if (page <= ((gSum - 1) * gNum))
                    {
                        ...
                        str += "│<a href='javascript:ShowDataByPost" + type + "(\"" + parameters + "page=" + (j * gNum + 1) + "\");' class='down'  title='后" + gNum.ToString() + "页'>...</a>│";
            ...
            else
            {
                ...
                str += "&nbsp;<a href='javascript:ShowDataByPost" + type + "(\"" + parameters + "page=" + (page + 1) + "\");' class='down'  title='下一页'>" + "下一页" + "</a>&nbsp;<a href='javascript:ShowDataByPost" + type + "(\"" + parameters + "page=" + pSum.ToString() + "\");' class='down' title='尾页'>尾页</a>";
        ...
        private string LinkStringJs(int groupLength, int totalcount, int pageSize, int pageIndex, int type)
        {
            ...
            else
            {
                ...
                str += "<a href='javascript:ShowDataByPost" + type + "(1);' class='down' title='首页'>首页</a>&nbsp;<a href='javascript:ShowDataByPost" + type + "(" + (page - 1) + ");' class='down' title='上一页'>上一页</a>&nbsp;";
            ...
            for (int j = 1; j <= gSum; j++)
            {
                if (page >= ((j - 1) * gNum + 1) && page <= (j * gNum))
                {
                    if (page > gNum)
                    {
                        ...
                        str += "│<a href='javascript:ShowDataByPost" + type + "(" + ((j - 2) * gNum + 1) + ");' class='down'   title='前" + gNum.ToString() + "页'>...</a>";
                    ...
                    for (int p = (j - 1) * gNum + 1; p <= (j * gNum); p++)
                    {
                        ...
                        else
                        {
                            if (p <= (j * gNum) && p <= pSum)
                            {
                                ...
                                str += "│<a href='javascript:ShowDataByPost" + type + "(" + p + ");' class='down'  title='第" + p.ToString() + "页'>" + p.ToString() + "</a>";
                    ...
                    if (page <= ((gSum - 1) * gNum))
                    {
                        ...
                        str += "│<a href='javascript:ShowDataByPost" + type + "(" + (j * gNum + 1) + ");' class='down'  title='后" + gNum.ToString() + "页'>...</a>│";
            ...
            else
            {
                ...
                str += "&nbsp;<a href='javascript:ShowDataByPost" + type + "(" + (page + 1) + ");' class='down'  title='下一页'>" + "下一页" + "</a>&nbsp;<a href='javascript:ShowDataByPost" + type + "(" + pSum.ToString() + ");' class='down' title='尾页'>尾页</a>";
        ...
        private string LinkStringJsForHC(string parameters, int groupLength, int totalcount, int pageSize, int pageIndex, int type)
        {
            ...
            else
            {
                ...
                str += "<a href='javascript:PageForHC(1);' class='down' title='首页'>首页</a>&nbsp;<a href='javascript:PageForHC(" + (page - 1) + ");' class='down' title='上一页'>上一页</a>&nbsp;";
            ...
            for (int j = 1; j <= gSum; j++)
            {
                if (page >= ((j - 1) * gNum + 1) && page <= (j * gNum))
                {
                    if (page > gNum)
                    {
                        ...
                        str += "│<a href='javascript:PageForHC(" + ((j - 2) * gNum + 1) + ");' class='down'   title='前" + gNum.ToString() + "页'>...</a>";
                    ...
                    for (int p = (j - 1) * gNum + 1; p <= (j * gNum); p++)
                    {
                        ...
                        else
                        {
                            if (p <= (j * gNum) && p <= pSum)
                            {
                                ...
                                str += "│<a href='javascript:PageForHC(" + p + ");' class='down'  title='第" + p.ToString() + "页'>" + p.ToString() + "</a>";
                    ...
                    if (page <= ((gSum - 1) * gNum))
                    {
                        ...
                        str += "│<a href='javascript:PageForHC(" + (j * gNum + 1) + ");' class='down'  title='后" + gNum.ToString() + "页'>...</a>│";
            ...
            else
            {
                ...
                str += "&nbsp;<a href='javascript:PageForHC(" + (page + 1) + ");' class='down'  title='下一页'>" + "下一页" + "</a>&nbsp;<a href='javascript:PageForHC(" + pSum + ");' class='down' title='尾页'>尾页</a>";

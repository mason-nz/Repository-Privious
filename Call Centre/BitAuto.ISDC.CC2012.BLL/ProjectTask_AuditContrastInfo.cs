...
namespace BitAuto.ISDC.CC2012.BLL
{
    public class ProjectTask_AuditContrastInfo
    {
        ...
        ///// <param name="tid">任务ID</param>
        ///// <returns></returns>
        //public int InsertByDelCustRelation(int tid, string cc_CustOriginalName, string cc_CustChangeName)
        //{
        //    Entities.ProjectTask_DelCustRelation delModel = BLL.ProjectTask_DelCustRelation.Instance.GetCC_DelCustRelationByTID(tid);
        //    if (delModel != null)
        //    {
        //        Entities.ProjectTask_AuditContrastInfo model = new Entities.ProjectTask_AuditContrastInfo();
        //        model.PTID = tid;
        ...
        //public int InsertByDMSMemberBrandChange(Entities.CC_DMSMember cc_DMSMember, BitAuto.YanFa.Crm2009.Entities.DMSMember DMSMember)
        //{
        //    int recid = -1;
        //    if (cc_DMSMember != null && DMSMember != null)
        //    {
        //        Entities.ProjectTask_AuditContrastInfo model = new Entities.ProjectTask_AuditContrastInfo();
        //        model.TID = cc_DMSMember.TID;
        ...
        ///// <param name="DMSMember">CRM系统会员实体</param>
        ///// <returns>返回插入记录主键ID</returns>
        //public int InsertByOpenedDMSMemberChange(Entities.CC_DMSMember cc_DMSMember, BitAuto.YanFa.Crm2009.Entities.DMSMember DMSMember)
        //{
        //    int recid = -1;
        //    if (cc_DMSMember != null && DMSMember != null)
        //    {
        ...
        //private void GetDMSMemberContrastByOpenedDMSMember(Entities.CC_DMSMember cc_DMSMember, BitAuto.YanFa.Crm2009.Entities.DMSMember DMSMember, ref string contrastInfoInside, ref string contrastInfo)
        //{
        //    if (!BLL.Util.IsEqualsByStringArray(cc_DMSMember.BrandIDs, DMSMember.BrandIds))
        //    {
        ...
        //        contrastInfo += "易湃会员所属省份由：" + Crm2009.BLL.MainBrand.Instance.GetAreaName(DMSMember.ProvinceID) +
        //                        "，改为：" + Crm2009.BLL.MainBrand.Instance.GetAreaName(cc_DMSMember.ProvinceID) + ",";
        //    }
        ...
        //        contrastInfo += "易湃会员所属城市由：" + Crm2009.BLL.MainBrand.Instance.GetAreaName(DMSMember.CityID) +
        //                        "，改为：" + Crm2009.BLL.MainBrand.Instance.GetAreaName(cc_DMSMember.CityID) + ",";
        //    }
        ...
        //        contrastInfo += "易湃会员所属区县由：" + Crm2009.BLL.MainBrand.Instance.GetAreaName(DMSMember.CountyID) +
        //                        "，改为：" + Crm2009.BLL.MainBrand.Instance.GetAreaName(cc_DMSMember.CountyID) + ",";
        //    }
        ...
        ///// <returns></returns>
        //private void IsEqualsByMapList(string ccmapLatitude,string ccmapLongitude, List<Crm2009.Entities.DMSMapCoordinate> dmsmaplist, ref string contrastInfoInside, ref string contrastInfo)
        //{


        //    if (dmsmaplist.Count > 0)
        //    {
        //        Crm2009.Entities.DMSMapCoordinate map = dmsmaplist[0];

        //            if (map.MapProviderName.ToLower() == Crm2009.Entities.Constants.Constant.MapProviderName.ToLower())
        //            {
        ...
        ///// <param name="DMSMember">CRM系统会员实体</param>
        ///// <returns>返回插入记录主键ID</returns>
        //public int InsertByDMSMemberChange(Entities.CC_DMSMember cc_DMSMember, BitAuto.YanFa.Crm2009.Entities.DMSMember DMSMember)
        //{
        //    int recid = -1;
        //    if (cc_DMSMember != null && DMSMember != null)
        //    {
        ...
        ///// <param name="contrastInfoInside"></param>
        ///// <param name="contrastInfo"></param>
        //private void GetDMSMemberContrastByPart1(Entities.CC_DMSMember cc_DMSMember, BitAuto.YanFa.Crm2009.Entities.DMSMember DMSMember, ref string contrastInfoInside, ref string contrastInfo)
        //{
        //    if (cc_DMSMember.Name != DMSMember.Name)
        //    {
        //        contrastInfoInside += "Name:('" + Util.EscapeString(DMSMember.Name) + "','" + Util.EscapeString(cc_DMSMember.Name) + "'),";
        ...
        //    //{
        //    //    contrastInfoInside += "TrafficInfo:('" + Util.EscapeString(DMSMember.TrafficInfo) + "','" + Util.EscapeString(cc_DMSMember.TrafficInfo) + "'),";
        //    //    contrastInfo += "会员交通信息由：" + DMSMember.TrafficInfo + "，改为：" + cc_DMSMember.TrafficInfo + ",";
        //    //}
        //    //if (cc_DMSMember.EnterpriseBrief != DMSMember.EnterpriseBrief)
        //    //{
        //    //    contrastInfoInside += "EnterpriseBrief:('" + Util.EscapeString(DMSMember.EnterpriseBrief) + "','" + Util.EscapeString(cc_DMSMember.EnterpriseBrief) + "'),";
        //    //    contrastInfo += "会员企业简介由：" + DMSMember.EnterpriseBrief + "，改为：" + cc_DMSMember.EnterpriseBrief + ",";
        //    //}
        //    //if (cc_DMSMember.Remarks != DMSMember.Remarks)
        //    //{
        //    //    contrastInfoInside += "Remarks:('" + Util.EscapeString(DMSMember.Remarks) + "','" + Util.EscapeString(cc_DMSMember.Remarks) + "'),";
        //    //    contrastInfo += "会员备注由：" + DMSMember.Remarks + "，改为：" + cc_DMSMember.Remarks + ",";
        //    //}
        //    contrastInfoInside = contrastInfoInside.TrimEnd(',');
        //    contrastInfo = contrastInfo.TrimEnd(',');
        //}

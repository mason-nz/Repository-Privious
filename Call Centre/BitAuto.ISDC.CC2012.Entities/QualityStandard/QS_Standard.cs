...
namespace BitAuto.ISDC.CC2012.Entities
{
	//----------------------------------------------------------------------------------
	/// <summary>
	/// 实体类QS_Standard 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	/// <author>
	/// masj
	/// </author>
	...
	public class QS_Standard
	{
        ...
        private string _qs_sexplanation;
        private int? _qs_skilllevel;

        public string QS_SExplanation
        {
            get { return _qs_sexplanation; }
            set { _qs_sexplanation = value; }
        }

        public int? QS_SkillLevel
        {
            get { return _qs_skilllevel; }
            set { _qs_skilllevel = value; }
        }
		/// <summary>
		/// 
		/// </summary>

...
namespace BitAuto.ISDC.CC2012.Entities
{
	//----------------------------------------------------------------------------------
	/// <summary>
	/// 实体类QueryDealerInfo 。(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	/// <author>
	/// masj
	/// </author>
	...
	//----------------------------------------------------------------------------------
	[Serializable]
	public class QueryDealerInfo
	{
		public QueryDealerInfo()
		{
         ...
         _cityscopes = Constant.STRING_INVALID_VALUE;
		}
		#region Model
		private int _recid;
        ...
        /// 
        /// </summary>
        public string CityScopes
        {
            set { _cityscopes = value; }
            get { return _cityscopes; }
        }
		#endregion Model

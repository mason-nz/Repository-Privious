...
namespace BitAuto.ISDC.CC2012.Entities
{
	...
	public class StopCustApply
	{
		public StopCustApply()
		{
         ...
         _applytype = Constant.INT_INVALID_VALUE;
         _applyreason = Constant.INT_INVALID_VALUE;
         _applyremark = Constant.INT_INVALID_VALUE;
		}
		#region Model
		private int _recid;

...
namespace BitAuto.ISDC.CC2012.Entities
{
    ...
    public class QueryYTGActivityTaskInfo
    {
        public QueryYTGActivityTaskInfo()
        {
            ...
            _subbegintime = Constant.STRING_INVALID_VALUE;
            _subendtime = Constant.STRING_INVALID_VALUE;
        }
        ...
        private string _subbegintime;
        private string _subendtime;

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="BitAuto.ISDC.CC2012.Web.ExternalTask.Login" %>
...
<body>
    <div class="page950">
        ...
        <div class="logo_info">
            ...
            <em id="liError">&nbsp;</em>
            <ul class="list">
                <li><i>帐号：</i><input onblur="ChangeText(this);" onclick="javascript:RemoveStyleAndText(this);"
            ...
            <div class="sumbit">
                <a onclick="javascript:return checkloginShowDiv();" class="bt_denglu" href="javascript:void(0);">
                    登录</a></div>
        </div>
        <div class="clear">
        </div>
        ...
        <div class="footer" style="padding-top: 120px">
            <p>
                信息系统研发中心 任何建议和意见，请发邮件至：<a href="mailto:ISDC@bitauto.com">ISDC@bitauto.com</a></p>
            <p>
                CopyRight © 2000-2012 Bitauto,All Rights Reserved 版权所有 北京易车互联信息技术有限公司</p>
        </div>
    </div>
</body>
...
<script type="text/javascript" language="JavaScript">
    ...
    function checkloginShowDiv() {
        ...
        //        }
        var postBody = "isVal=yes&username=" + URLencode(name.val()) + "&pwd=" + URLencode(pwd.val()) + "&AgentNum=" + agentNum; //构造要携带的数据
        postBody += '&ReturnUrl=' + request('ReturnUrl');

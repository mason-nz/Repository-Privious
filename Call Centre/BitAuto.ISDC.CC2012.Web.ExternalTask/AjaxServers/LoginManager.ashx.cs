...
namespace BitAuto.ISDC.CC2012.Web.ExternalTask.AjaxServers
{
    /// <summary>
    /// LoginManager 的摘要说明
    /// </summary>
    public class LoginManager : IHttpHandler, IRequiresSessionState
    {
        ...
        {
            get { return currentContext.Request.Form["ReturnUrl"] == null ? string.Empty : currentContext.Request.Form["ReturnUrl"].Trim(); }
        }
        #endregion
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (currentContext.Request.Form["isVal"] == "yes")
            {
                ...
                if ((RequestUsername != null && RequestUsername.Length > 0) && (RequestPWD != null && RequestPWD.Length > 0))
                {
                    ...
                    //    && BLL.CC_Employee_Agent.Instance.IsExist(agentNum, Convert.ToInt32(Session["userid"])) == false)//有坐席号
                    //{
                    //    ret = -9;//坐席号错误
                    //}
                    //else

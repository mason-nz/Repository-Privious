...
function GooCalendar(InputID, property) {
    ...
    this.$div = $("<div id='" + this.$divId + "' class='Calendar' style='display:none; z-index:9999'></div>");
    ...
    temp = "<div class='top'><b class='arrow'><div class='left'></div></b><b class='arrow' style='float:right;'><div class='right'></div></b></div>" +
		...
		"<div class='bottom'><div class='cal_btn'>今天</div><div class='time'></div><div class='cal_btn' style='float:right'>取消</div></div>";

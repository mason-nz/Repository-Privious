...
{
    public class ConsultDFeedback : DataBase
    {
        #region Instance
        ...
        #region const
        private const string P_ConsultDFeedback_SELECT = "p_ConsultDFeedback_Select";
        private const string P_ConsultDFeedback_INSERT = "p_ConsultDFeedback_Insert";
        private const string P_ConsultDFeedback_UPDATE = "p_ConsultDFeedback_Update";
        private const string P_ConsultDFeedback_DELETE = "p_ConsultDFeedback_Delete";
        #endregion
        ...
        public DataTable GetConsultDFeedback(QueryConsultDFeedback query, string order, int currentPage, int pageSize, out int totalCount)
        {
            ...
            ds = SqlHelper.ExecuteDataset(CONNECTIONSTRINGS, CommandType.StoredProcedure, P_ConsultDFeedback_SELECT, parameters);
        ...
        public Entities.ConsultDFeedback GetConsultDFeedback(int RecID)
        {
            ...
            if (count > 0)
            {
                return LoadSingleConsultDFeedback(dt.Rows[0]);
            }
            else
            {
                return null;
        ...
        public int Update(Entities.ConsultDFeedback model)
        {
            ...
            return SqlHelper.ExecuteNonQuery(CONNECTIONSTRINGS, CommandType.StoredProcedure, P_ConsultDFeedback_UPDATE, parameters);
        }
        #endregion
        ...
        public int Delete(int RecID)
        {
            ...
            return SqlHelper.ExecuteNonQuery(CONNECTIONSTRINGS, CommandType.StoredProcedure, P_ConsultDFeedback_DELETE, parameters);
        }
        #endregion
    }
}

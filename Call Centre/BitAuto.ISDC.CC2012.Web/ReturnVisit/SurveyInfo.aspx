<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SurveyInfo.aspx.cs" Inherits="BitAuto.ISDC.CC2012.Web.ReturnVisit.SurveyInfo" %>

<%@ Register Src="~/ReturnVisit/UCSurveyInfoEdit.ascx" TagName="UCSurveyInfoEdit"
    TagPrefix="uc1" %>
<%@ Register Src="~/ReturnVisit/UCSurveyInfoView.ascx" TagName="UCSurveyInfoView"
    TagPrefix="uc2" %>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function surveySubmit() {
            ...
            var pody = {
                ...
                CustID: '<%=RequestCustID%>',
                IsSub: '0',
                JsonSurveyAnswer: encodeURIComponent(jsonSurveyAnswer),
                r: Math.random()
            };
            $.post("/AjaxServers/ReturnVisit/TakingAnSurveyHandler.ashx", pody, function (data) {
    ...
    <div class="w980">
        ...
        <div class="btn" style="margin: 20px auto;">
            <input type="button" name="" value="保 存" onclick="surveySubmit()" runat="server"
                id="btnsave" />&nbsp;&nbsp;<input type="button" name="" value="提 交" onclick="surveySubmitLast()"
                    runat="server" id="btnsub" />&nbsp;&nbsp;<input type="button" name="" value="关 闭"
                        onclick="javascript:closePage();" runat="server" id="Button1" />
        </div>
    </div>
    </form>
</body>

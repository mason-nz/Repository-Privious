<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskLogList.aspx.cs" Inherits="BitAuto.ISDC.CC2012.Web.CustInfo.DetailV.TaskLogList" %>
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                 ...
                 <td>
                    <%# getStatus(Eval("TaskStatus").ToString())%>
                </td>
                <td>
                    <%#Eval("TrueName")%>                  
                </td>

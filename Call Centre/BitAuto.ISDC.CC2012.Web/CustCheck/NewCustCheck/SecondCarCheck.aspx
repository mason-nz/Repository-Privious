<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecondCarCheck.aspx.cs"
    Inherits="BitAuto.ISDC.CC2012.Web.CustCheck.NewCustCheck.SecondCarCheck" %>
...
<body>
    ...
    <div class="w980">
        ...
        <div class="baseInfo clearfix">
            <uc1:UCEditCust ID="UCCustInfo" runat="server" />
        </div>
        <div class="btn">
            ...
            <%} %>
            <input type="button" onclick="javascript:closePage();;" class="button" value="关闭" />
        </div>
    </div>
    </form>
</body>

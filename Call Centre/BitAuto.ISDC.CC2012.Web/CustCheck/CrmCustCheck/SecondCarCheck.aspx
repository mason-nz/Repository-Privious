<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SecondCarCheck.aspx.cs"
    Inherits="BitAuto.ISDC.CC2012.Web.CustCheck.CrmCustCheck.SecondCarCheck" %>

<!--功能废弃 强斐 2016-8-19-->
<%@ Register Src="../../CustInfo/EditVWithCalling/UCEditSecondCarCust.ascx" TagName="UCEditCust"
    TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>非4S客户信息核实</title>
        ...
        $(function () {
            ...
            ADTTool.onDisconnected = function (data) {
                ...
                if (data.IsEstablished == "True") {
                    ...
                    //录音自动绑定会员
                    var PTID = '<%=TID %>';
                    var postBody = { Action: 'AutoBindRecord', SessionID: data.RecordID, TID: PTID, DataSource: 2, EstablishEndTime: data.CurrentDate };
...
<body>
    ...
    <div class="w980">
        ...
        <div class="baseInfo clearfix">
            <uc2:UCEditCust ID="UCEditCust1" runat="server" />
        </div>
        <div class="btn">
            ...
            <div style="display: none">
                <input type="button" id="BtnDel" onclick="javascript:uCEditCustHelper.stopCustInfo('/CustCheck/CheckTaskList.aspx');"
                    class="button" style="margin-right: 50px;" value="停用" /></div>

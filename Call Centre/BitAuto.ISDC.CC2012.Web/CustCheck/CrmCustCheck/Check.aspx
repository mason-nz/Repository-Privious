<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Check.aspx.cs" Inherits="BitAuto.ISDC.CC2012.Web.CustCheck.CrmCustCheck.Check" %>
...
<body>
    ...
    <div class="w980">
        ...
        <div class="baseInfo clearfix">
            ...
            <%--<uc:Bottom ID="Bottom" runat="server" />--%>
        </div>
    </div>
    </form>
</body>

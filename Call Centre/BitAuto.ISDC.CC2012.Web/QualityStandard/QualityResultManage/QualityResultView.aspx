<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualityResultView.aspx.cs"
    Inherits="BitAuto.ISDC.CC2012.Web.QualityStandard.QualityResultManage.QualityResultView" %>

<%@ Register Src="~/QualityStandard/UCQualityStandard/UCQualityStandardView.ascx"
    TagName="UCQualityStandardView" TagPrefix="uc1" %>
...
<body>
    ...
    <div class="w980">
        ...
        <uc1:UCQualityStandardView ID="QualityStandardViewID" runat="server" />

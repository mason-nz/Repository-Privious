<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualityResultFiveLevelView.aspx.cs" Inherits="BitAuto.ISDC.CC2012.Web.QualityStandard.QualityResultManage.QualityResultFiveLevelView" %>

<%@ Register Src="~/QualityStandard/UCQualityStandard/UCQualityStandardFiveLevelView.ascx"
    TagName="UCQualityStandardFiveLevelView" TagPrefix="uc1" %>
<%@ Register Src="../UCQualityStandard/UCCallRecordView.ascx" TagName="UCCallRecordView"
    TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>录音质检成绩查看</title>

...
{
    public partial class UCQualityStandardEditFiveLevelForState : System.Web.UI.UserControl
    {
        //是否有致命项
        ...
        protected DataTable GetItemTableByQS_CID(string QS_CID)
        {
            if (dtItem != null && dtItem.Rows.Count > 0)
            {
                ...
                DataColumn col2 = new DataColumn("QS_RDID", typeof(string));
                    ...
                    for (int i = 0; i < arr.Length + 1; i++)
                    {
                        if (i == arr.Length)
                        {
                            ...
                            if (arrRowResultStandars != null && arrRowResultStandars.Length > 0)
                            {
                                ...
                                newrow[i + 1] = arrRowResultStandars[0]["QS_RDID"];
                            }
                            else
                            {
                                newrow[i] = "";
        ...
        /// <returns></returns>
        public string IsExistResultDetailForMarking(string QSID, string type)
        {
            string str = "";
            if (dtResultDetail != null && dtResultDetail.Rows.Count > 0)
            {

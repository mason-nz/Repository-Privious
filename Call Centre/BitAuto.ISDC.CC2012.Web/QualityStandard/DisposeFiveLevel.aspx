<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DisposeFiveLevel.aspx.cs" Title="" Inherits="BitAuto.ISDC.CC2012.Web.QualityStandard.DisposeFiveLevel" %>

<%@ Register Src="~/QualityStandard/UCQualityStandard/UCQualityStandardEditFiveLevelForState.ascx" 
TagName="UCQualityStandardEditForState" TagPrefix="uc1" %>
 

<%@ Register Src="~/QualityStandard/UCQualityStandard/UCQualityStandardFiveLevelView.ascx"
    TagName="UCQualityStandardFiveLevelView" TagPrefix="uc2" %>
<%@ Register Src="~/QualityStandard/UCQualityStandard/UCCallRecordView.ascx" TagName="UCCallRecordView" TagPrefix="uc3" %>
...
<body>
    ...
    <div class="w980 zj">
        ...
        <!--录音基本信息-->
        <!--服务规范-->
        <uc1:UCQualityStandardEditForState ID="ucTableDispose" runat="server" />
        <uc2:UCQualityStandardFiveLevelView ID="UCScoreTableView" runat="server" />

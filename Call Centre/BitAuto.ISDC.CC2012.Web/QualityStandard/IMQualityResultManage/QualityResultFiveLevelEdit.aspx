<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualityResultFiveLevelEdit.aspx.cs"
    Inherits="BitAuto.ISDC.CC2012.Web.QualityStandard.IMQualityResultManage.QualityResultFiveLevelEdit" %>
...
<body>
    <div class="lsjl_zj">
        <!--左历史记录start   border-right: #CCC 1px solid;border-bottom: #CCC 1px solid;-->
        <div class="framediv" style="position: fixed; z-index: 3;width: 362px;height:880px;background: #FFF; *margin-left:-370px;border-bottom: #CCC 1px solid;">
            <iframe id="iframepage"  marginheight="0" marginwidth="0" frameborder="0" width="362" style=" height:99%; overflow:hidden; " name="iframepage" onLoad="contenerSize();">
            </iframe>
        </div>
        <!--左历史记录end-->
        <!--右内容start-->

<%@ Page Title="白名单" Language="C#" MasterPageFile="~/Controls/Top.Master" AutoEventWireup="true"
    CodeBehind="WhiteList.aspx.cs" Inherits="BitAuto.ISDC.CC2012.Web.BlackWhite.WhiteList" %>
    ...
    <div class="search clearfix">
        ...
        <ul class="clear">
            <li>
                <label>
                    添加人：</label>
                <input type="text" id="txtSelAddUser" class="w190" readonly="true" onclick="SelectVisitPerson('addwhitedatauser','txtSelAddUser','hidSelAddUser')" />
            ...
            <li style="width: 286px; *width: 287px; margin-right: 0px;">
                <label>
                    类型：</label>
                <span style="display: block; width: 90px; float: left; margin-left: 0px; *margin-left: 0px;
                    padding-left: 0px;">
                ...
                <span style="display: block; width: 90px; float: left;">
                    <input type="checkbox" value="2" id="chkCallOut" name="CallTypes" /><em onclick="emChkIsChoose(this);">呼出</em></span></li>
    ...
    <script type="text/javascript">
        ...
        function openUploadExcelInfoPopup() {
            $.openPopupLayer({
                ...
                parameters: { Action: 'batchimport', Type: 1 },
        ...
        function search(page) {
            ...
            $("#ajaxTable").load("/BlackWhite/AjaxService/WhiteDataList.aspx", podyStr, transBusinessType);
        ...
        function ShowDataByPost1(pody) {
            LoadingAnimation("ajaxTable");
            $("#ajaxTable").load("/BlackWhite/AjaxService/WhiteDataList.aspx", pody, transBusinessType);
        }
        ...
        function AddBlackData() {
            $.openPopupLayer({
                ...
                parameters: {},
                url: "/BlackWhite/AddWhiteData.aspx?r=" + Math.random()
            });

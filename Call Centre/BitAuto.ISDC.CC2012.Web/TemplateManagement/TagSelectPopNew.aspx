<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TagSelectPopNew.aspx.cs"
    Inherits="BitAuto.ISDC.CC2012.Web.TemplateManagement.TagSelectPopNew" %>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('.Contentbox').find('li').click(function (eve) {
                ...
                choose$.empty().append('<li class="lichoose" name="imgDelTag"  did="' + this$.attr('did') + '">' + txt + '&nbsp;<img src="../Css/img/xz_close.png"></li>');
            });
...
<body>
    ...
    <div class="pop pb15 w820">
        <div class="title bold">
            选择标签<span><a href="#" onclick="javascript:$.closePopupLayer('TagSelectPopNew',false);"></a></span>
        </div>
        <div class="xz_bq">
            <div class="bq1 clearfix" style="border-bottom-width: 0px;">
                <span>已选择标签</span>
                <ul class="choose">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BlackWhiteListOperLogList.aspx.cs"
    Inherits="BitAuto.ISDC.CC2012.Web.WOrderV2.AjaxServers.CustInfoTab.BlackWhiteListOperLogList" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        function ShowDataByPost1015(pody) {
            LoadingAnimation("bit_table5");
            $('#bit_table5').load('/WOrderV2/AjaxServers/CustInfoTab/BlackWhiteListOperLogList.aspx #bit_table5 > *', pody, function () { });
        }
    </script>
</head>
<body>
    <form id="form1" runat="server">
    <div class="search_list2" id="bit_table5">

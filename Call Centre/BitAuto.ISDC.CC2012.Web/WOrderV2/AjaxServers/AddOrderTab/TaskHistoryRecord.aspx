<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskHistoryRecord.aspx.cs"
    Inherits="BitAuto.ISDC.CC2012.Web.WOrderV2.AjaxServers.AddOrderTab.TaskHistoryRecord" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowDataByPost1011(pody) {
            ...
            $('#bit_table1').load('/WOrderV2/AjaxServers/AddOrderTab/TaskHistoryRecord.aspx #bit_table1 > *', pody);
        }
    </script>
</head>
<body>
    ...
    <div class="search_list" id="bit_table1">

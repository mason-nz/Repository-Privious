<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SMSSendHistoryList.aspx.cs"
    Inherits="BitAuto.ISDC.CC2012.Web.WOrderV2.AjaxServers.AddOrderTab.SMSSendHistoryList" %>

<!--根据手机号码查询短信 强斐 2016-8-10-->
<script type="text/javascript">
    //分页操作
    function ShowDataByPost1014(pody) {
        LoadingAnimation("bit_table1", "search_list_bt_loading");
        $('#bit_table4').load('/WOrderV2/AjaxServers/AddOrderTab/SMSSendHistoryList.aspx #bit_table4 > *', pody);
    }
</script>
<div class="clearfix">
</div>
...
<div id="bit_table4" class="search_list">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="YTGActivityTaskOperationLog.aspx.cs" Inherits="BitAuto.ISDC.CC2012.Web.YTGActivityTask.AjaxServers.YTGActivityTaskOperationLog" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>易团购操作记录页</title>
     <script type="text/javascript">
         //分页操作
         function ShowDataByPost1(pody) {
             LoadingAnimation("divHandlerHistory");
             $('.bit_table').load('../YTGActivityTask/AjaxServers/YTGActivityTaskOperationLog.aspx .bit_table > *', pody);
         }
    </script>
</head>
<body>

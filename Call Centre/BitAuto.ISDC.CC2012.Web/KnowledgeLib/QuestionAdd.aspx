<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QuestionAdd.aspx.cs" Inherits="BitAuto.ISDC.CC2012.Web.KnowledgeLib.QuestionAdd" %>
         ...
         var uCEditQuestionHelper = (function () {
             ...
             deleteOption = function (obj) {
                 ...
                 if ($(objParent).parent().children().size() > 2) {
                     $(objParent).prev().prepend("<span class='delete'><a href='javascript:void(0)' onclick='javascript:uCEditQuestionHelper.DeleteOption(this)'></a></span>&nbsp;<span class='add'><a href='javascript:void(0)' onclick='javascript:uCEditQuestionHelper.AddOption(this)'></a></span>");
                 }
                 $(objParent).remove();
             },
             //新增选项
             ...
             addRadioQustion = function (num) {
                 ...
                 htmlStr += "<li class='xzt'><label name='QuestionOrder'>" + num + "、</label><span><input name='questionAsk' type='text'  class='w600'/></span><input type='hidden' name='hdnAskCategory' value=1>";
                 ...
                 htmlStr += "<span class='delete'><a href='javascript:void(0)' onclick='javascript:uCEditQuestionHelper.DeleteOption(this)'></a></span>&nbsp;<span class='add'><a href='javascript:void(0)' onclick='javascript:uCEditQuestionHelper.AddOption(this)'></a></span></li>";
                 htmlStr += "</ul>";
            ...
            AddCheckQuestion = function (num) {
                var htmlStr = "<ul name='ulQuestion' id='ulQuestion" + num + "'>";
                htmlStr += "<li class='xzt'><label name='QuestionOrder'>" + num + "、</label><span><input name='questionAsk' type='text'  class='w600'/></span><input type='hidden' name='hdnAskCategory' value=2>&nbsp;";
                htmlStr += "<span><select  name='sltQuestionType' class='w100' ><option value='radio'>单选题</option><option value='checkbox'>复选题</option><option  value='text'>主观题</option><option value='select'>判断题</option></select></span>";
                htmlStr += "<span class='delete'><a href='javascript:void(0)' onclick='javascript:uCEditQuestionHelper.DeleteQuestion(" + num + ")'></a></span>&nbsp;<span class='add'><a href='javascript:void(0)' onclick='javascript:uCEditQuestionHelper.AddQuestionSelectType(this)'></a></span>";
                htmlStr += "<ul>";
            ...
            AddSubjectiveQuestion = function (num) {
                var htmlStr = "<ul name='ulQuestion' id='ulQuestion" + num + "'>";
                htmlStr += "<li class='xzt'><label name='QuestionOrder'>" + num + "、</label><span><input name='questionAsk' type='text'  class='w600'/></span><input type='hidden' name='hdnAskCategory' value=3>&nbsp;";
                htmlStr += "<span><select  name='sltQuestionType' class='w100'><option value='radio'>单选题</option><option value='checkbox'>复选题</option><option  value='text' >主观题</option><option value='select'>判断题</option></select></span>";
                htmlStr += "<span class='delete'><a href='javascript:void(0)' onclick='javascript:uCEditQuestionHelper.DeleteQuestion(" + num + ")'></a></span>&nbsp;<span class='add'><a href='javascript:void(0)' onclick='javascript:uCEditQuestionHelper.AddQuestionSelectType(this)'></a></span>";
            ...
            AddJudgeQuestion = function (num) {
                var htmlStr = "<ul name='ulQuestion' id='ulQuestion" + num + "'>";
                htmlStr += "<li class='xzt'><label name='QuestionOrder'>" + num + "、</label><span><input name='questionAsk' type='text'  class='w600'/></span><input type='hidden' name='hdnAskCategory' value='4' />&nbsp;";
                htmlStr += "<span><select  name='sltQuestionType' class='w100'><option value='radio'>单选题</option><option value='checkbox'>复选题</option><option  value='text'>主观题</option><option value='select'>判断题</option></select></span>";
                htmlStr += "<span class='delete'><a href='javascript:void(0)' onclick='javascript:uCEditQuestionHelper.DeleteQuestion(" + num + ")'></a></span>&nbsp;<span class='add'><a href='javascript:void(0)' onclick='javascript:uCEditQuestionHelper.AddQuestionSelectType(this)'></a></span>";
                htmlStr += "<ul>";

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AssignTask.aspx.cs" Inherits="BitAuto.ISDC.CC2012.Web.AjaxServers.TaskManager.NoDealerOrder.AssignTask" %>
...
<script type="text/javascript">
    ...
    function SelectPerson(userid) {
        var TaskIDS = '<%=TaskIDS%>';
        $.post("../../AjaxServers/TaskManager/NoDealerOrder/Handler.ashx", { Action: "AssignTask", TaskIDS: encodeURIComponent(TaskIDS), AssignUserID: userid }, function (data) {
    ...
    function ShowDataByPost1(pody) {
        $('#divPersonList').load('../../AjaxServers/TaskManager/NoDealerOrder/AssignTask.aspx #divPersonList > *', pody + '&random=' + Math.random(), LoadDivSuccess);
    }
</script>
<div class="pop pb15 openwindow">
    ...
    <ul class="clearfix  outTable">
        ...
        <li style="width: 200px; float: left;">姓名：
            <input type="text" name="txtUserName" id="txtUserName" runat="server" class="w180" /></li>
        <li class="btn">

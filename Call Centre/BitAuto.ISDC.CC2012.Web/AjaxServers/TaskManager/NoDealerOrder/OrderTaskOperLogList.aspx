<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderTaskOperLogList.aspx.cs"
    Inherits="BitAuto.ISDC.CC2012.Web.AjaxServers.TaskManager.NoDealerOrder.OrderTaskOperLogList" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function ShowDataByPost1(pody) {
            ...
            $('.bit_table').load('../AjaxServers/TaskManager/NoDealerOrder/OrderTaskOperLogList.aspx .bit_table > *', pody);
        }
    </script>
</head>
<body>
            ...
            <asp:Repeater ID="repeaterTableList" runat="server">
                <ItemTemplate>
                    <tr class="back" style="font-size: 12px" onmouseover="this.className='hover'" onmouseout="this.className='back'">
                        ...
                        <td>
                            <div style="width: 100%" class="deal" title="<%#getNoDealReason(Eval("OperationStatus").ToString(),Eval("TaskID").ToString())[1]%>">
                                <%# getNoDealReason(Eval("OperationStatus").ToString(), Eval("TaskID").ToString())[0]%></div>
                        </td>
                        <td>

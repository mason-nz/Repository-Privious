...
{
    public partial class SatisfactionListForBJ : PageBase
    {
        #region 属性
        /// <summary>
        /// 坐席ID
        ...
        public void BindData()
        {
            ...
            DataTable dt = BLL.CallRecord_ORIG.Instance.GetSatisfactionList(query, "", BLL.PageCommon.Instance.PageIndex, PageSize, out RecordCount, 2, b, e, _DateType, tableEndName);

            //查询汇总行
            //if (dt != null && dt.Rows.Count > 0)
            //{
                int RecordCountSum = 0;
                DataTable dth = BLL.CallRecord_ORIG.Instance.GetSatisfactionList(query, "", 1, 1, out RecordCountSum, 2, b, e, tableEndName);

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZuoxiTableList.aspx.cs"
    Inherits="BitAuto.ISDC.CC2012.Web.AjaxServers.ZuoxiManage.ZuoxiTableList" %>

<div class="bit_table" id="bit_table">
    <div class="optionBtn clearfix" style="clear: both">
        <%if (updateRoleAuth)
          { %>
        <input type="button" value=" 批量修改角色 " onclick="updateUsersRigth()" class="newBtn"
            style="*margin-top: 3px;" />
        <%} if (AreaManageAuth)
          { %>
        <input type="button" value=" 区域管理 " onclick="AreaManage()" class="newBtn" style="*margin-top: 3px;" />
        <%} %>
    </div>

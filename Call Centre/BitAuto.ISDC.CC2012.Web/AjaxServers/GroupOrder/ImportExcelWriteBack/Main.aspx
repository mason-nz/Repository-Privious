<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Main.aspx.cs" Inherits="BitAuto.ISDC.CC2012.Web.GroupOrder.ImportExcelWriteBack.Main" %>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#uploadify").uploadify({
            ...
            'uploader': '/AjaxServers/GroupOrder/ImportExcelWriteBack/HandlerImport.ashx?userId='+ <%=userId %>,
            'auto': false,
            'multi': false,
            'width': 78,
            'height': 32,
...
<div class="pop pb15 openwindow" style="height: 215px">
    ...
    <!--主体内容设计部分-->
    <ul class="part01">
        <li style="width: 300px"><a style="margin-left: 12px; margin-right: 20px;" href="../Statistics/MemberIDImport/Templet/Excel回写导入模板.xls">
            下载Excel回写导入模板</a></li>

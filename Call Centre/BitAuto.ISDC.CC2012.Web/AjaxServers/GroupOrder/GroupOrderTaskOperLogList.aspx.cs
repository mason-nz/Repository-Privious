...
{
    public partial class GroupOrderTaskOperLogList : PageBase
    {
        #region 属性
        ...
        private void BindData()
        {
            ...
            DataTable dt = BLL.GroupOrderTaskOperationLog.Instance.GetGroupOrderTaskOperationLog(query, "a.CreateTime asc", 1, 10000, out RecordCount);
        ...
        public string getStatusName(string status)
        {
            ...
            {
                name = BLL.Util.GetEnumOptText(typeof(Entities.GroupTaskStatus), _status);
            }
            return name;
        }
        ...
        public string getActionName(string action, string remark)
        {
            ...
            {
                actionName = BLL.Util.GetEnumOptText(typeof(Entities.GO_OperationStatus), _action);

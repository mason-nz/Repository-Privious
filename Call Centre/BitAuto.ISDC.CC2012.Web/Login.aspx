<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="BitAuto.ISDC.CC2012.Web.Login" %>
...
<body>
    <div class="page950">
        ...
        <div class="logo_info">
            <h2>
                用户登录</h2>
            <a target="_self" href="javascript:void(0);" onclick=" window.external.MethodScript('http://ncc.sys.bitauto.com/SurveyInfo/SurveyMapping/ExportExcel.aspx?SIID=508&ProjectID=5828&typeID=4&tasksubstart=2014-12-02&tasksubend=2014-12-03&Browser=');">CallTest</a> <span id="spanBrower"></span><em id="liError">
                &nbsp;</em>
            <ul class="list">
        ...
        <div class="footer" style="padding-top: 120px">
            ...
            <p style="color: #999; text-align: center; line-height: 24px; vertical-align: bottom;
                font-family: 宋体">
                <span style="font-family: Times New Roman">CopyRight &copy; 2000-<%=DateTime.Now.Year %> Bitauto,All Rights

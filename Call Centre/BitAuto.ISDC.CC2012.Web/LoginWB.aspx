<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginWB.aspx.cs" Inherits="BitAuto.ISDC.CC2012.Web.LoginWB" %>
...
<head>
    ...
    <script type="text/javascript">
        function UpdatePassword() {
            $.openPopupLayer({
                name: "UpdatePasswordPoper",
                parameters: {},
                url: "ModifyPassword.aspx",
...
<body>
    <div class="page950">
        ...
        <div class="logo_info">
            <h2>
                用户登录</h2>
            <a href="/cti/CTI_Test.aspx">CallTest</a>   <span id="spanBrower"></span><em id="liError">
                &nbsp;</em>
            <ul class="list">
                ...
                <li class="two">
                    <input name="ckxRememberMe" id="ckxRememberMe" checked="checked" type="checkbox"
                        value="" class="fxk" />记住域帐号&nbsp;&nbsp;<a href="javascript:void(0)" onclick="UpdatePassword()">修改密码</a></li>
            </ul>
            <div class="sumbit">
                <a onclick="javascript:return checkloginShowDiv();" id="btnLogin" class="bt_denglu" href="javascript:void(0);">
                    登录</a></div>
        </div>
        <div class="clear">
        </div>
        ...
        <p style="color: #999; text-align: center; line-height: 24px; vertical-align: bottom;
            font-family: 宋体">
            <span style="font-family: Times New Roman">CopyRight &copy; 2000-2014
...
<script type="text/javascript" language="JavaScript">
    ...
    function checkloginShowDiv() {
        ...
        //        }
        var postBody = "isVal=login2&username=" + URLencode(name.val()) + "&pwd=" + URLencode(pwd.val()) + "&AgentNum=" + agentNum + '&gourl=' + URLencode(request('gourl')); //构造要携带的数据 

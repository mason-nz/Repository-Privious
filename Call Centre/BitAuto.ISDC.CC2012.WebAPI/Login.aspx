...
<head>
    ...
    <link href="Content/Css/CC/login.css" rel="stylesheet" type="text/css" />
    ...
    <%--  <style type="text/css">
      #btnLogin {
            display: inline-block; width: 80px; padding: 8px;text-align: center;
        ...
        <div class="logo_info">
            ...
            <div class="sumbit">
                <a onclick="javascript:return checkloginShowDiv();" id="btnLogin" class="bt_denglu"
                    style="background: url('Content/Css/CC/img/logonew.png') no-repeat 0 -132px;"
        ...
        function PostPalyCallbackLoad(data, textStatus, xhr) {
            if (textStatus == 'success' && data.Success) {
                ...
                if (s == '-3') {
                    ...
                    alert("登录成功");
                    var search = request('red');
                    if (search != null && search != '') {
                        window.location = search;
                    } else {
                        window.location = "/AutoCallItemMonitor.aspx";
                    }
                }
                else {
                    var error = $('#liError');
